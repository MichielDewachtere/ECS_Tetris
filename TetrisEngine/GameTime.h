#ifndef TETRISENGINE_GAMETIME_H
#define TETRISENGINE_GAMETIME_H
...
float monthly::GameTime::GetTime(uint32_t id)
{
...
template<typename DurationType>
float monthly::GameTime::EndTimer(uint32_t id)
{
